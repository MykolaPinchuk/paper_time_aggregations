...
This matches a streaming evaluation setting in which click outcomes become available with a one-hour delay.
...
\begin{table}[t]
  \centering
  \small
  \input{tables/feature_counts_10pct_te_timeagg_grid_clean.tex}
...
\begin{table}[t]
  ...
  \small
  \resizebox{\linewidth}{!}{%
  \input{tables/top_specs_absolute_metrics_10pct_te_timeagg_clean.tex}
  }
